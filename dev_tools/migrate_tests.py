...
print("\n=== unit/type_system ===")
move("test_advanced_types.py",         "unit/type_system/test_advanced_types.py")
...
move("test_ffi_advanced.py",                     "unit/memory/test_ffi_advanced.py")
...
move("test_build_advanced.py",         "tooling/test_build_advanced.py")
