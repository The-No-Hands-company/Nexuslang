...
Command-line interface for NLPL static analysis.
...
from nlpl.tooling.analyzer import StaticAnalyzer, AnalysisReport
from nlpl.tooling.analyzer.analyzer import (
