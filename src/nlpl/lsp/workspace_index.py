...
Usage:
    ...
    file_symbols = index.get_symbols_in_file("file:///path/to/file.nlpl")
"""
...
class SymbolInfo:
    ...
    Attributes:
        ...
        file_uri: File URI (e.g., "file:///path/to/file.nlpl")
...
class WorkspaceIndex:
    ...
    def scan_workspace(self, progress_callback=None) -> None:
        ...
        # Find all .nlpl files
        nlpl_files = self._find_nlpl_files()
        total_files = len(nlpl_files)
        
        logger.info(f"Found {total_files} .nlpl files")
        
        # Index each file
        for idx, file_path in enumerate(nlpl_files, 1):
            try:
    ...
    def _path_to_uri(self, file_path: str) -> str:
        ...
        Returns:
            File URI (e.g., "file:///path/to/file.nlpl")
        """
