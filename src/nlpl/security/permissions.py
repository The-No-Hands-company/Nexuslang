...
This module implements a comprehensive permission system for NLPL that controls
...
class PermissionManager:
    """
    Manages permissions for NLPL runtime.
    ...
    def _prompt_for_permission(self, permission_type: PermissionType, resource: str) -> bool:
        ...
        print(f"\n⚠️  NLPL requests {permission_type.name} permission", file=sys.stderr)
