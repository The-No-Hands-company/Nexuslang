...
Provides multi-layer execution sandboxing for NLPL programs:
...
3. SeccompFilter (Linux only)
   - Installs a Berkeley Packet Filter (BPF) program via the seccomp(2)
     syscall to restrict which system calls the NLPL process may invoke.
