...
Static and dynamic analysis tools for detecting security issues in NLPL programs:
...
class TaintLabel(enum.Enum):
    ...
    ENV_VAR = 20         # Value from os.environ or NLPL env access
...
class CallGraph:
    ...
    def register_call_site(self, site_name: str,
        ...
        Args:
            site_name:     Name identifying the call site (e.g. the NLPL variable name).
...
class MemorySafetyValidator:
    ...
    This validator wraps the NLPL interpreter's managed-memory layer
