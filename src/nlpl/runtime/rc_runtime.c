/**
 * NLPL Reference Counted Smart Pointer Runtime Library
 * 
 * Provides reference counting functionality for NLPL Rc<T>, Weak<T>, and Arc<T> types.
 * 
 * Memory Layout:
 * ┌──────────────┬──────────────┬──────────────┐
 ...
 * └──────────────┴──────────────┴──────────────┘
 * 
 * The pointer returned to NLPL code points to the data section.
