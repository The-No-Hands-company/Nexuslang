...
class CHeaderGenerator:
    """Generates C header files from NLPL AST."""
    ...
    def generate(self, ast: Program, output_name: str = "nlpl_module") -> str:
    ...
    def _map_type(self, nlpl_type: str) -> str:
        ...
        return mapping.get(nlpl_type, "void*") # Default to void* for objects/unknowns
