...
class FFICallTracer:
    ...
    Usage::
        ...
        # Export
        tracer.export_json("/tmp/nlpl_ffi_trace.json")
    """
...
class GDBScriptGenerator:
    ...
    def __init__(self, symbol_prefix: str = "nlpl_ffi_"):
    ...
    def generate(self, program_path: str) -> str:
        ...
        """
        lines = [
            f"# GDB script generated by NLPL FFI debugger",
            f"# Load with: gdb -x <this_file> {program_path}",
            f"",
            f"set pagination off",
            f"set logging on nlpl_ffi_debug.gdb.log",
        ...
        lines += [
            ...
            "",
            "# ---- Post-mortem ----",
            "echo \\n=== NLPL FFI Debug Session Complete ===\\n",
            "info breakpoints",
            "quit",
        ]
...
class LLDBScriptGenerator:
    ...
    def generate(self, program_path: str) -> str:
        ...
        """
        lines = [
            f"# LLDB script generated by NLPL FFI debugger",
...
def generate_valgrind_command(
    ...
    Args:
        program_path: Path to the compiled NLPL program.
