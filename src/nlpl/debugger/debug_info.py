"""
DWARF Debug Information Generator for NLPL
===========================================

Generates DWARF debug information for NLPL programs compiled to LLVM IR.
...
class DebugInfoGenerator:
    ...
    def generate_basic_type(self, type_name: str, size: int, encoding: str) -> str:
        ...
        Args:
            type_name: NLPL type name (Integer, Float, String, etc.)
            size: Size in bits
