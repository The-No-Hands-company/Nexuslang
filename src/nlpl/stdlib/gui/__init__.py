...
and audio modules so NLPL code can pass lightweight integers across function
...
def register_gui_functions(runtime: Runtime) -> None:
    """Register all GUI functions with the NLPL runtime."""
