"""
Simple OBJ mesh loader for NLPL
...
def register_mesh_functions(runtime):
    """Register mesh loading functions with NLPL runtime"""
    
    def nlpl_load_obj(filepath: str):
    ...
    runtime.register_function("load_obj_mesh", nlpl_load_obj)
    runtime.register_function("create_cube_mesh", nlpl_create_cube_mesh)
