"""
OS Kernel Primitives standard library for NLPL.
...
do not support the requested functionality (raises NLPLRuntimeError or returns
...
class NLPLProcess:
    """Represents a child process spawned by NLPL."""
...
# Signal constants exposed to NLPL
...
def register_kernel_functions(runtime: Any) -> None:
    """Register all kernel primitive functions with the NLPL runtime."""
