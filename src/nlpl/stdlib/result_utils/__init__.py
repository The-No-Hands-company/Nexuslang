"""result_utils — Result/Option types and structured error chaining for NLPL.
...
def _call(fn, *args):
    """Invoke fn which may be a Python callable or an NLPL runtime value."""
    if callable(fn):
        return fn(*args)
...
def register_result_utils_functions(runtime: "Runtime") -> None:
    """Register all result_utils functions with the NLPL runtime."""
    # Result constructors
