...
Implements a three-phase PGO workflow for NLPL programs:
...
Usage
-----
    from nlpl.tooling.pgo import PGODriver, PGOConfig
...
class PGOConfig:
    ...
    profile_filename: str = "nlpl.prof"
...
class PGORuntimeCollector:
    """
    Collects PGO profile data from the NLPL interpreter at runtime.
