...
Tracks which source lines are executed during NLPL program runs and
...
Usage (from tooling)::
    ...
    from nlpl.tooling.coverage import run_with_coverage
...
class CoverageCollector:
    """
    Hooks into the NLPL interpreter to track executed lines.
...
def run_with_coverage(
    ...
    """
    Run an NLPL source file with coverage collection enabled.
