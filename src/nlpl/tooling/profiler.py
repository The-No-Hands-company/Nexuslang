...
CPU-time and memory-allocation profiler for NLPL programs.
...
Both hook into the NLPL interpreter via the ``_profiler`` slot on the
...
def run_with_profiling(
    ...
    """
    Run an NLPL source file with profiling enabled.
