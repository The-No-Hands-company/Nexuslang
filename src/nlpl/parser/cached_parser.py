"""
Cached Parser Wrapper for NLPL
================================
...
from nlpl.parser.ast_cache import ASTCache, get_global_cache
...
class CachedParser:
    ...
    def parse(self, file_path: str, source_code: str, debug: bool = False) -> any:
        ...
        Args:
            ...
            source_code: NLPL source code to parse
