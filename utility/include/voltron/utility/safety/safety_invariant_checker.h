...
/**
 * @brief Check safety-critical invariants
 * 
...
private:
    ...
    SafetyInvariantChecker(SafetyInvariantChecker&&) = delete;
    SafetyInvariantChecker& operator=(SafetyInvariantChecker&&) = delete;
