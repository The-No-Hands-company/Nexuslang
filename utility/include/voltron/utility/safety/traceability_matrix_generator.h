...
/**
 * @brief Generate requirements traceability
 * 
...
private:
    ...
    TraceabilityMatrixGenerator(TraceabilityMatrixGenerator&&) = delete;
    TraceabilityMatrixGenerator& operator=(TraceabilityMatrixGenerator&&) = delete;
