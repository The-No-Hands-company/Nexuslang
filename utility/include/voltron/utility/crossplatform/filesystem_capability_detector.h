...
/**
 * @brief Detect filesystem capabilities
 * 
...
private:
    ...
    FilesystemCapabilityDetector(FilesystemCapabilityDetector&&) = delete;
    FilesystemCapabilityDetector& operator=(FilesystemCapabilityDetector&&) = delete;
