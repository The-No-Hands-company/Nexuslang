...
/**
 * @brief Aerospace certification support
 * 
...
private:
    ...
    AerospaceCertificationHelper(AerospaceCertificationHelper&&) = delete;
    AerospaceCertificationHelper& operator=(AerospaceCertificationHelper&&) = delete;
