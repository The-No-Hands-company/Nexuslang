...
/**
 * @brief Detect API breaking changes
 * 
...
private:
    ...
    ApiBreakingChangeDetector(ApiBreakingChangeDetector&&) = delete;
    ApiBreakingChangeDetector& operator=(ApiBreakingChangeDetector&&) = delete;
