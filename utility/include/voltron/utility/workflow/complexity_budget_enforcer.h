...
/**
 * @brief Enforce complexity budgets
 * 
...
private:
    ...
    ComplexityBudgetEnforcer(ComplexityBudgetEnforcer&&) = delete;
    ComplexityBudgetEnforcer& operator=(ComplexityBudgetEnforcer&&) = delete;
