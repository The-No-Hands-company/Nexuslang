...
/**
 * @brief Validate WebAssembly interface boundaries
 * 
...
private:
    ...
    WasmInterfaceValidator(WasmInterfaceValidator&&) = delete;
    WasmInterfaceValidator& operator=(WasmInterfaceValidator&&) = delete;
