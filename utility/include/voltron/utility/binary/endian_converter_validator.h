...
/**
 * @brief Validate endianness conversions
 * 
...
private:
    ...
    EndianConverterValidator(EndianConverterValidator&&) = delete;
    EndianConverterValidator& operator=(EndianConverterValidator&&) = delete;
