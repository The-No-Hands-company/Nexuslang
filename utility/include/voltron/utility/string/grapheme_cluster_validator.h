...
/**
 * @brief Validate Unicode grapheme clusters
 * 
...
private:
    ...
    GraphemeClusterValidator(GraphemeClusterValidator&&) = delete;
    GraphemeClusterValidator& operator=(GraphemeClusterValidator&&) = delete;
