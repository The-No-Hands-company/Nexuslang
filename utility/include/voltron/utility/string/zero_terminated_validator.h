...
/**
 * @brief Validate null-terminated strings
 * 
...
private:
    ...
    ZeroTerminatedValidator(ZeroTerminatedValidator&&) = delete;
    ZeroTerminatedValidator& operator=(ZeroTerminatedValidator&&) = delete;
