...
/**
 * @brief Query language for diagnostics
 * 
...
private:
    ...
    DiagnosticQueryLanguage(DiagnosticQueryLanguage&&) = delete;
    DiagnosticQueryLanguage& operator=(DiagnosticQueryLanguage&&) = delete;
