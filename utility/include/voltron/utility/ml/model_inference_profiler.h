...
/**
 * @brief Profile machine learning inference
 * 
...
private:
    ...
    ModelInferenceProfiler(ModelInferenceProfiler&&) = delete;
    ModelInferenceProfiler& operator=(ModelInferenceProfiler&&) = delete;
