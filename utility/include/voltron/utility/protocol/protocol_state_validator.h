...
/**
 * @brief Validate protocol state machines
 * 
...
private:
    ...
    ProtocolStateValidator(ProtocolStateValidator&&) = delete;
    ProtocolStateValidator& operator=(ProtocolStateValidator&&) = delete;
