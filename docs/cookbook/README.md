...
- [Common Tasks](common-tasks.md) — File I/O, JSON, HTTP, multithreading, CLI args
- [Domain Recipes](domain-recipes.md) — Data pipelines, web scraping, automation, scientific computing, business applications

## How to Use This Cookbook

1. Find the recipe closest to your task.
